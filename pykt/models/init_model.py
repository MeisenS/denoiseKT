...
from .desaint import desaint
from .desakt import desakt
from .deakt import deakt
...
def init_model(model_name, model_config, data_config, emb_type):
    if model_name == "dkt":
    ...
    elif model_name == "desakt":
        model = desakt(data_config["num_c"],  **model_config, emb_type=emb_type, emb_path=data_config["emb_path"]).to(device)
    ...
    elif model_name == "desaint":
        model = desaint(data_config["num_q"], data_config["num_c"], **model_config, emb_type=emb_type, emb_path=data_config["emb_path"]).to(device)
        ...
        model = deakt(data_config["num_c"], data_config["num_q"], **model_config, emb_type=emb_type, emb_path=data_config["emb_path"]).to(device)
